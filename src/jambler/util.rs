...
impl TimeStamp {
    ...
    pub fn rprint_normal(&self) {
        if self.days != 0 {
            ...
            rprint!("d {} {}:{} s {} ms {}: ", self.days, self.hours, self.minutes, self.seconds, self.milliseconds);
        }
        else if self.hours != 0 {
            rprint!("{}:{} s {} ms {}: ", self.hours, self.minutes, self.seconds, self.milliseconds);
        }
        else if self.minutes != 0 {
            rprint!("min {} s {} ms {}: ", self.minutes, self.seconds, self.milliseconds);
        }
    ...
    pub fn rprint_normal_with_micros(&self) {
        if self.days != 0 {
            ...
            rprint!("d {} {}:{} s {} ms {} micros {}: ", self.days, self.hours, self.minutes, self.seconds, self.milliseconds, self.microseconds);
        }
        else if self.hours != 0 {
            rprint!("{}:{} s {} ms {} micros {}: ", self.hours, self.minutes, self.seconds, self.milliseconds, self.microseconds);
        }
        else if self.minutes != 0 {
            rprint!("min {} s {} ms {} micros {}: ", self.minutes, self.seconds, self.milliseconds, self.microseconds);
        }
        else if self.seconds != 0 {
            rprint!("s {} ms {} micros {}: ", self.seconds, self.milliseconds, self.microseconds);
        }
        else if self.milliseconds != 0 {
    ...
    pub fn rprint_precise(&self) {
        rprint!("s {} ms {} micros {}: ", self.original_micro_seconds / 1_000_000, self.milliseconds, self.microseconds);
    }
